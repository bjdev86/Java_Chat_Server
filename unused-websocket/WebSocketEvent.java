...
public class WebSocketEvent 
{
 // Local Variable Declaration 
    ...
    private WebsocketStringDataHandler stringHandler = null;
    private WebsocketByteDataHandler byteHandler = null;
    private WebsocketFramedDataHandler frameHandler = null;
     ...
     * @param framedHndlr
     */
    public WebSocketEvent (byte[] payload, byte opcode, int frameSize, String dir,
                           WebsocketFramedDataHandler framedHndlr)
    {
        this.payload = payload;
        this.opcode = opcode; 
